...
@_raw_string1681 = global [4 x i8] c"123\00"
@_raw_string1679 = global [4 x i8] c"789\00"
@_raw_string1671 = global [4 x i8] c"def\00"
@_raw_string1669 = global [4 x i8] c"abc\00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_result_id1680 = bitcast [4 x i8]* @_raw_string1681 to i8*
  %_result_id1678 = bitcast [4 x i8]* @_raw_string1679 to i8*
  ...
  store i8* %_result_id1680, i8** %_1684
  %_1682 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_array1677, i32 0, i32 1, i32 0
  store i8* %_result_id1678, i8** %_1682
  %_result_id1670 = bitcast [4 x i8]* @_raw_string1671 to i8*
  %_result_id1668 = bitcast [4 x i8]* @_raw_string1669 to i8*
