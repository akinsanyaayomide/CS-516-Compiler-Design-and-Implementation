...
@_raw_string3068 = global [2 x i8] c" \00"
@_raw_string3074 = global [2 x i8] c" \00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_result_id3067 = bitcast [2 x i8]* @_raw_string3068 to i8*
  call void @print_string(i8* %_result_id3067)
  ...
  %_result_id3073 = bitcast [2 x i8]* @_raw_string3074 to i8*
  call void @print_string(i8* %_result_id3073)
