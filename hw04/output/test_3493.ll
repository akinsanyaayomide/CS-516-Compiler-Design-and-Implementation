...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer974 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_id_arr973, i32 0, i32 1, i32 0
  %_index_value975 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_index_pointer974
  %_index_pointer976 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_index_value975, i32 0, i32 1, i32 0
