...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store { i64, [0 x i64] }* %_array1043, { i64, [0 x i64] }** %_1041
  %_id_arr1048 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_1041
  %_index_pointer1049 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_arr1048, i32 0, i32 1, i32 1
  %_index_value1050 = load i64, i64* %_index_pointer1049
  ret i64 %_index_value1050
}
