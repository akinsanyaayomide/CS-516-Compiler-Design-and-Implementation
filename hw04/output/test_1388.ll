...
_start344:
  ...
  br i1 %_id_b341, label %_then345, label %_else346
_then345:
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer334 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_333, i32 0, i32 1, i32 0
  %_index_value335 = load i64, i64* %_index_pointer334
  ...
  %_index_pointer329 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_328, i32 0, i32 1, i32 0
  %_index_value330 = load i64, i64* %_index_pointer329
  %_336 = add i64 %_index_value330, %_index_value335
  store i64 %_336, i64* %_325
