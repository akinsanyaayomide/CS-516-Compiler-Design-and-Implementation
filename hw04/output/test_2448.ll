...
_begin_if2804:
  ...
  %_2789 = icmp slt i64 %_id_l2787, %_id_r2788
  br i1 %_2789, label %_then_branch2805, label %_else_branch2806
_then_branch2805:
  ...
  %_2797 = sub i64 %_id_j2796, 1
  call void @quick_sort({ i64, [0 x i64] }* %_id_a2794, i64 %_id_l2795, i64 %_2797)
  %_id_a2799 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2783
  %_id_j2800 = load i64, i64* %_2786
  %_2801 = add i64 %_id_j2800, 1
  %_id_r2802 = load i64, i64* %_r2785
  call void @quick_sort({ i64, [0 x i64] }* %_id_a2799, i64 %_2801, i64 %_id_r2802)
...
define i64 @partition({ i64, [0 x i64] }* %a, i64 %l, i64 %r) {
  ...
  %_index_pointer2695 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a2693, i32 0, i32 1, i64 %_id_l2694
  %_index_value2696 = load i64, i64* %_index_pointer2695
  store i64 %_index_value2696, i64* %_2692
  %_id_l2698 = load i64, i64* %_l2690
  store i64 %_id_l2698, i64* %_2697
  %_id_r2700 = load i64, i64* %_r2691
  %_2701 = add i64 %_id_r2700, 1
  store i64 %_2701, i64* %_2699
  store i64 0, i64* %_2702
  store i64 0, i64* %_2703
  br label %_start2764
_start2764:
  %_id_done2704 = load i64, i64* %_2703
  %_2705 = icmp eq i64 %_id_done2704, 0
  br i1 %_2705, label %_body2765, label %_else2766
_body2765:
  %_id_i2706 = load i64, i64* %_2697
  %_2707 = add i64 %_id_i2706, 1
  store i64 %_2707, i64* %_2697
  br label %_start2720
_start2720:
  %_id_r2715 = load i64, i64* %_r2691
  %_id_i2714 = load i64, i64* %_2697
  %_2716 = icmp sle i64 %_id_i2714, %_id_r2715
  %_id_pivot2712 = load i64, i64* %_2692
  %_id_a2708 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2689
  %_id_i2709 = load i64, i64* %_2697
  %_index_pointer2710 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a2708, i32 0, i32 1, i64 %_id_i2709
  %_index_value2711 = load i64, i64* %_index_pointer2710
  %_2713 = icmp sle i64 %_index_value2711, %_id_pivot2712
  %_2717 = and i1 %_2713, %_2716
  br i1 %_2717, label %_body2721, label %_else2722
_body2721:
  %_id_i2718 = load i64, i64* %_2697
  %_2719 = add i64 %_id_i2718, 1
  store i64 %_2719, i64* %_2697
  br label %_start2720
_else2722:
  %_id_j2723 = load i64, i64* %_2699
  %_2724 = sub i64 %_id_j2723, 1
  store i64 %_2724, i64* %_2699
  br label %_start2733
_start2733:
  %_id_pivot2729 = load i64, i64* %_2692
  %_id_a2725 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2689
  %_id_j2726 = load i64, i64* %_2699
  %_index_pointer2727 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a2725, i32 0, i32 1, i64 %_id_j2726
  %_index_value2728 = load i64, i64* %_index_pointer2727
  %_2730 = icmp sgt i64 %_index_value2728, %_id_pivot2729
  br i1 %_2730, label %_body2734, label %_else2735
_body2734:
  %_id_j2731 = load i64, i64* %_2699
  %_2732 = sub i64 %_id_j2731, 1
  store i64 %_2732, i64* %_2699
  br label %_start2733
_else2735:
...
_begin_if2739:
  ...
  %_2738 = icmp sge i64 %_id_i2736, %_id_j2737
  br i1 %_2738, label %_then_branch2740, label %_else_branch2741
_then_branch2740:
...
_begin_if2760:
  ...
  %_2744 = icmp eq i64 %_id_done2743, 0
  br i1 %_2744, label %_then_branch2761, label %_else_branch2762
_then_branch2761:
  %_id_a2745 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2689
  %_id_i2746 = load i64, i64* %_2697
  %_index_pointer2747 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a2745, i32 0, i32 1, i64 %_id_i2746
  %_index_value2748 = load i64, i64* %_index_pointer2747
  store i64 %_index_value2748, i64* %_2702
  %_id_a2749 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2689
  %_id_j2750 = load i64, i64* %_2699
  %_index_pointer2751 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a2749, i32 0, i32 1, i64 %_id_j2750
  ...
  store i64 %_index_value2752, i64* %_2755
...
_else2766:
  ...
  %_index_pointer2769 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a2767, i32 0, i32 1, i64 %_id_l2768
  %_index_value2770 = load i64, i64* %_index_pointer2769
  store i64 %_index_value2770, i64* %_2702
  %_id_a2771 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a2689
  %_id_j2772 = load i64, i64* %_2699
  %_index_pointer2773 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a2771, i32 0, i32 1, i64 %_id_j2772
  ...
  store i64 %_index_value2774, i64* %_2777
