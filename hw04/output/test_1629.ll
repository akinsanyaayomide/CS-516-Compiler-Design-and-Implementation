...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer948 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_id_arr947, i32 0, i32 1, i32 1
  %_index_value949 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_index_pointer948
  %_index_pointer950 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_index_value949, i32 0, i32 1, i32 1
  %_index_value951 = load i64, i64* %_index_pointer950
  ret i64 %_index_value951
}
