...
define i64 @fact(i64 %x) {
  ...
  store i64 1, i64* %_797
  br label %_start805
_start805:
  %_id_x798 = load i64, i64* %_x796
  %_799 = icmp sgt i64 %_id_x798, 0
  br i1 %_799, label %_body806, label %_else807
_body806:
  %_id_x801 = load i64, i64* %_x796
  %_id_acc800 = load i64, i64* %_797
  %_802 = mul i64 %_id_acc800, %_id_x801
  store i64 %_802, i64* %_797
  %_id_x803 = load i64, i64* %_x796
  %_804 = sub i64 %_id_x803, 1
  store i64 %_804, i64* %_x796
  br label %_start805
_else807:
  %_id_acc808 = load i64, i64* %_797
  ret i64 %_id_acc808
}
