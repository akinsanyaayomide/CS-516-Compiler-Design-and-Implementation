...
@_str_arr1649 = global [4 x i8] c"abc\00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_str1652 = getelementptr [4 x i8], [4 x i8]* @_str_arr1651, i32 0, i32 0
  %_str1650 = getelementptr [4 x i8], [4 x i8]* @_str_arr1649, i32 0, i32 0
