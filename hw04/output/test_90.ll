...
@_raw_string3378 = global [2 x i8] c" \00"
@_raw_string3386 = global [2 x i8] c"	\00"
...
_body3383:
  ...
  %_result_id3377 = bitcast [2 x i8]* @_raw_string3378 to i8*
  call void @print_string(i8* %_result_id3377)
  %_id_j3380 = load i64, i64* %_3366
  %_3381 = add i64 %_id_j3380, 1
  store i64 %_3381, i64* %_3366
  br label %_start3382
_else3384:
  %_result_id3385 = bitcast [2 x i8]* @_raw_string3386 to i8*
  call void @print_string(i8* %_result_id3385)
