...
define i64 @min({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_index_pointer4065 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_arr4063, i32 0, i32 1, i32 0
  %_index_value4064 = load i64, i64* %_index_pointer4065
  store i64 %_index_value4064, i64* %_4062
...
_then_branch4081:
  ...
  store i64 %_index_value4078, i64* %_4062
...
define i64 @max({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_index_pointer4035 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_arr4033, i32 0, i32 1, i32 0
  %_index_value4034 = load i64, i64* %_index_pointer4035
  store i64 %_index_value4034, i64* %_4032
...
_then_branch4051:
  ...
  store i64 %_index_value4048, i64* %_4032
