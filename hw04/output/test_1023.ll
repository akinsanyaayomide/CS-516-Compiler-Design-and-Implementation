...
@_string2549 = global [11 x i8] c"1234967890\00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_string12550 = getelementptr [11 x i8], [11 x i8]* @_string2549, i32 0, i32 0
  %_2551 = call { i64, [0 x i64] }* @array_of_string(i8* %_string12550)
