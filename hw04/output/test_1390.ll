...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer364 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_i363, i32 0, i32 1, i32 0
  %_index_value365 = load i64, i64* %_index_pointer364
  ret i64 %_index_value365
}
