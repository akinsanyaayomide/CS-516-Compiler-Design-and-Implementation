...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_string13068 = getelementptr [2 x i8], [2 x i8]* @_string3067, i32 0, i32 0
  call void @print_string(i8* %_string13068)
  ...
  %_string13074 = getelementptr [2 x i8], [2 x i8]* @_string3073, i32 0, i32 0
  call void @print_string(i8* %_string13074)
