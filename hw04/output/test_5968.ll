...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_cond34
_cond34:
  %_id_i27 = load i64, i64* %_i26
  %_bop28 = icmp slt i64 %_id_i27, 3
  br i1 %_bop28, label %_if35, label %_merge33
_if35:
  %_id_x29 = load i64, i64* %_x25
  %_bop30 = add i64 %_id_x29, 2
  store i64 %_bop30, i64* %_x25
  %_id_i31 = load i64, i64* %_i26
  %_bop32 = add i64 %_id_i31, 1
  store i64 %_bop32, i64* %_i26
  br label %_cond34
_merge33:
  %_id_x36 = load i64, i64* %_x25
  ret i64 %_id_x36
}
