...
@_str_arr3246 = global [2 x i8] c" \00"
@_str_arr3252 = global [2 x i8] c" \00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_str3247 = getelementptr [2 x i8], [2 x i8]* @_str_arr3246, i32 0, i32 0
  call void @print_string(i8* %_str3247)
  ...
  %_str3253 = getelementptr [2 x i8], [2 x i8]* @_str_arr3252, i32 0, i32 0
  call void @print_string(i8* %_str3253)
