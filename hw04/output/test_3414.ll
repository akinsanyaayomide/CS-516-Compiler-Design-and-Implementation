...
@_string2521 = global [13 x i8] c"Hello world!\00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_string12522 = getelementptr [13 x i8], [13 x i8]* @_string2521, i32 0, i32 0
  store i8* %_string12522, i8** %_2520
  %_id_str2523 = load i8*, i8** %_2520
