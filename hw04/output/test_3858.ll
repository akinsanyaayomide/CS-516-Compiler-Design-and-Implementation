...
_begin_if4614:
  ...
  %_index_pointer4575 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a4572, i32 0, i32 1, i64 %_bop4574
  ...
  %_bop4581 = icmp sle i64 %_index_value4576, %_index_value4580
  br i1 %_bop4581, label %_then_branch4615, label %_else_branch4616
_then_branch4615:
  %_id_j4582 = load i64, i64* %_4568
  store i64 %_id_j4582, i64* %_4567
  %_id_j4583 = load i64, i64* %_4568
  %_bop4584 = add i64 %_id_j4583, 1
  store i64 %_bop4584, i64* %_4568
  br label %_end_if4617
_else_branch4616:
  %_id_a4586 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_a4565
  %_id_i4587 = load i64, i64* %_4567
  %_bop4588 = sub i64 %_id_i4587, 1
  %_index_pointer4589 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a4586, i32 0, i32 1, i64 %_bop4588
