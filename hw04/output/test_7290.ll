...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer1034 = getelementptr { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }, { i64, [0 x { i64, [0 x { i64, [0 x i64] }*] }*] }* %_id_arr1032, i32 0, i32 1, i32 2
  %_index_value1033 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** %_index_pointer1034
  %_index_pointer1036 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_index_value1033, i32 0, i32 1, i32 0
  %_index_value1035 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_index_pointer1036
  %_index_pointer1038 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_index_value1035, i32 0, i32 1, i32 1
  %_index_value1037 = load i64, i64* %_index_pointer1038
  ret i64 %_index_value1037
}
