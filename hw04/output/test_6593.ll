...
@_string4510 = global [2 x i8] c"T\00"
@_string4508 = global [2 x i8] c"F\00"
...
define i8* @string_of_bool(i1 %b) {
  ...
  br label %_begin_if4515
_begin_if4515:
  %_id_b4507 = load i1, i1* %_b4506
  br i1 %_id_b4507, label %_then_branch4514, label %_else_branch4513
_then_branch4514:
...
_if4505:
  ...
  %_id_i4501 = load i64, i64* %_i4491
  %_bop4502 = add i64 %_id_i4501, 1
  store i64 %_bop4502, i64* %_i4491
  br label %_cond4504
_merge4503:
  ret void
}
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_lfsr_register4421 = alloca { i64, [0 x i1] }*
  %_i4422 = alloca i64
  %_i4438 = alloca i64
  %_new_first4453 = alloca i1
  %_j4456 = alloca i64
  store i64 %argc, i64* %_argc4416
  store { i64, [0 x i8*] }* %argv, { i64, [0 x i8*] }** %_argv4417
  %_id_lfsr_length4418 = load i64, i64* @lfsr_length
  %_raw_array4419 = call i64* @oat_alloc_array(i64 %_id_lfsr_length4418)
  %_array4420 = bitcast i64* %_raw_array4419 to { i64, [0 x i1] }*
  store { i64, [0 x i1] }* %_array4420, { i64, [0 x i1] }** %_lfsr_register4421
  store i64 0, i64* %_i4422
  br label %_cond4436
_cond4436:
  %_id_i4423 = load i64, i64* %_i4422
  %_id_lfsr_length4424 = load i64, i64* @lfsr_length
  %_bop4425 = icmp slt i64 %_id_i4423, %_id_lfsr_length4424
  br i1 %_bop4425, label %_if4437, label %_merge4435
_if4437:
  %_id_lfsr_init_values4426 = bitcast { i64, [4 x i1] }* @lfsr_init_values to { i64, [0 x i1] }*
  %_id_i4427 = load i64, i64* %_i4422
  ...
  %_id_lfsr_register4430 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register4421
  %_id_i4431 = load i64, i64* %_i4422
  ...
  %_id_i4433 = load i64, i64* %_i4422
  %_bop4434 = add i64 %_id_i4433, 1
  store i64 %_bop4434, i64* %_i4422
  br label %_cond4436
_merge4435:
  store i64 0, i64* %_i4438
  br label %_cond4478
_cond4478:
  %_id_i4439 = load i64, i64* %_i4438
  %_id_lfsr_iterations4440 = load i64, i64* @lfsr_iterations
  %_bop4441 = icmp slt i64 %_id_i4439, %_id_lfsr_iterations4440
  br i1 %_bop4441, label %_if4479, label %_merge4477
_if4479:
  %_id_lfsr_register4442 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register4421
  %_id_lfsr_length4443 = load i64, i64* @lfsr_length
  %_bop4444 = sub i64 %_id_lfsr_length4443, 1
  %_index_pointer4446 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_id_lfsr_register4442, i32 0, i32 1, i64 %_bop4444
  %_index_value4445 = load i1, i1* %_index_pointer4446
  %_id_lfsr_register4447 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register4421
  %_id_lfsr_length4448 = load i64, i64* @lfsr_length
  %_bop4449 = sub i64 %_id_lfsr_length4448, 2
  %_index_pointer4451 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_id_lfsr_register4447, i32 0, i32 1, i64 %_bop4449
  %_index_value4450 = load i1, i1* %_index_pointer4451
  %_4452 = call i1 @xor(i1 %_index_value4445, i1 %_index_value4450)
  store i1 %_4452, i1* %_new_first4453
  %_id_lfsr_length4454 = load i64, i64* @lfsr_length
  %_bop4455 = sub i64 %_id_lfsr_length4454, 1
  store i64 %_bop4455, i64* %_j4456
  br label %_cond4470
_cond4470:
  %_id_j4457 = load i64, i64* %_j4456
  %_bop4458 = icmp sgt i64 %_id_j4457, 0
  br i1 %_bop4458, label %_if4471, label %_merge4469
_if4471:
  %_id_lfsr_register4459 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register4421
  %_id_j4460 = load i64, i64* %_j4456
  ...
  %_id_lfsr_register4464 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register4421
  %_id_j4465 = load i64, i64* %_j4456
  ...
  %_id_j4467 = load i64, i64* %_j4456
  %_bop4468 = sub i64 %_id_j4467, 1
  store i64 %_bop4468, i64* %_j4456
  br label %_cond4470
_merge4469:
  %_id_new_first4472 = load i1, i1* %_new_first4453
  %_id_lfsr_register4473 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register4421
  %_4474 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_id_lfsr_register4473, i32 0, i32 1, i32 0
  store i1 %_id_new_first4472, i1* %_4474
  %_id_i4475 = load i64, i64* %_i4438
  %_bop4476 = add i64 %_id_i4475, 1
  store i64 %_bop4476, i64* %_i4438
  br label %_cond4478
_merge4477:
  ...
  %_id_lfsr_register4486 = load { i64, [0 x i1] }*, { i64, [0 x i1] }** %_lfsr_register4421
