...
define i64 @xor_shift_plus({ i64, [0 x i64] }* %s) {
  ...
  %_index_pointer3787 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_s3785, i32 0, i32 1, i32 0
  %_index_value3786 = load i64, i64* %_index_pointer3787
  store i64 %_index_value3786, i64* %_3784
  %_id_s3789 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_s3783
  %_index_pointer3791 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_s3789, i32 0, i32 1, i32 1
  %_index_value3790 = load i64, i64* %_index_pointer3791
  store i64 %_index_value3790, i64* %_3788
...
_cond3772:
  ...
  br i1 %_bop3762, label %_if3771, label %_merge3773
_if3771:
