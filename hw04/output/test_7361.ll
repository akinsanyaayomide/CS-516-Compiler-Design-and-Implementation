...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %args) {
  ...
  %_index_pointer224 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_arr222, i32 0, i32 1, i32 2
  %_index_value223 = load i64, i64* %_index_pointer224
  ret i64 %_index_value223
}
