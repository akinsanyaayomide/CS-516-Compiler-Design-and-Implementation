...
define { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %x, { i64, [0 x i64] }* %y, i1 %b) {
  ...
  store i1 %b, i1* %_b267
  br label %_begin_if274
_begin_if274:
  %_id_b268 = load i1, i1* %_b267
  br i1 %_id_b268, label %_then_branch273, label %_else_branch272
_then_branch273:
  %_id_x270 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x265
  ret { i64, [0 x i64] }* %_id_x270
_else_branch272:
  %_id_y269 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_y266
  ret { i64, [0 x i64] }* %_id_y269
}
...
_cond240:
  ...
  br i1 %_bop232, label %_if241, label %_merge239
_if241:
...
_cond256:
  ...
  br i1 %_bop247, label %_if257, label %_merge255
_if257:
