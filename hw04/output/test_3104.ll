...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer1609 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a1608, i32 0, i32 1, i32 2
  %_index_value1610 = load i64, i64* %_index_pointer1609
  ret i64 %_index_value1610
}
