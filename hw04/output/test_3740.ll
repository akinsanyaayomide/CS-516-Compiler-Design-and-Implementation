...
_begin_if3028:
  ...
  br i1 %_bop3009, label %_then_branch3029, label %_else_branch3030
_then_branch3029:
...
_begin_if2946:
  ...
  %_bop2923 = icmp slt i64 %_index_value2918, %_index_value2922
  br i1 %_bop2923, label %_then_branch2947, label %_else_branch2948
_then_branch2947:
  ...
  store i64 %_bop2932, i64* %_2900
  %_id_i2933 = load i64, i64* %_2898
  %_bop2934 = add i64 %_id_i2933, 1
  store i64 %_bop2934, i64* %_2898
...
_else_branch2948:
  ...
  store i64 %_bop2943, i64* %_2900
  %_id_j2944 = load i64, i64* %_2899
  %_bop2945 = add i64 %_id_j2944, 1
  store i64 %_bop2945, i64* %_2899
  br label %_end_if2949
_end_if2949:
  br label %_cond2951
_merge2952:
...
_if2967:
  ...
  store i64 %_bop2964, i64* %_2900
  %_id_i2965 = load i64, i64* %_2898
  %_bop2966 = add i64 %_id_i2965, 1
  store i64 %_bop2966, i64* %_2898
  br label %_cond2968
_merge2969:
  br label %_cond2985
_cond2985:
...
_if2984:
  ...
  store i64 %_bop2981, i64* %_2900
  %_id_j2982 = load i64, i64* %_2899
  %_bop2983 = add i64 %_id_j2982, 1
  store i64 %_bop2983, i64* %_2899
  br label %_cond2985
_merge2986:
