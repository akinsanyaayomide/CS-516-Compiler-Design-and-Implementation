...
@_raw_string3247 = global [2 x i8] c" \00"
@_raw_string3253 = global [2 x i8] c" \00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_result_id3246 = bitcast [2 x i8]* @_raw_string3247 to i8*
  call void @print_string(i8* %_result_id3246)
  ...
  %_result_id3252 = bitcast [2 x i8]* @_raw_string3253 to i8*
  call void @print_string(i8* %_result_id3252)
