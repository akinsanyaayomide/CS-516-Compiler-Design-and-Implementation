...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_str1652 = getelementptr [4 x i8], [4 x i8]* @_string1651, i32 0, i32 0
  %_str1650 = getelementptr [4 x i8], [4 x i8]* @_string1649, i32 0, i32 0
