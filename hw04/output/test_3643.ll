...
define void @min_heapify({ i64, [0 x i64] }* %array, i64 %i, i64 %len) {
  ...
  %_bop4254 = mul i64 %_id_i4253, 2
  store i64 %_bop4254, i64* %_4252
  %_id_i4256 = load i64, i64* %_i4250
  %_bop4257 = add i64 %_id_i4256, 1
  store i64 %_bop4257, i64* %_4255
...
_begin_if4278:
  ...
  br i1 %_bop4263, label %_then_branch4279, label %_else_branch4280
_then_branch4279:
...
_begin_if4274:
  ...
  %_bop4272 = icmp sgt i64 %_index_value4267, %_index_value4271
  br i1 %_bop4272, label %_then_branch4275, label %_else_branch4276
_then_branch4275:
...
_begin_if4299:
  ...
  br i1 %_bop4284, label %_then_branch4300, label %_else_branch4301
_then_branch4300:
...
_begin_if4295:
  ...
  %_bop4293 = icmp sgt i64 %_index_value4288, %_index_value4292
  br i1 %_bop4293, label %_then_branch4296, label %_else_branch4297
_then_branch4296:
...
_begin_if4325:
  ...
  br i1 %_bop4305, label %_then_branch4326, label %_else_branch4327
_then_branch4326:
...
_begin_if4224:
  ...
  %_bop4223 = icmp ne i64 %_index_value4218, %_index_value4222
  br i1 %_bop4223, label %_then_branch4225, label %_else_branch4226
_then_branch4225:
