...
_start4086:
  ...
  %_4069 = icmp slt i64 %_id_i4067, %_id_len4068
  br i1 %_4069, label %_body4087, label %_else4088
_body4087:
...
_begin_if4080:
  ...
  %_4075 = icmp slt i64 %_index_value4073, %_id_min4074
  br i1 %_4075, label %_then_branch4081, label %_else_branch4082
_then_branch4081:
...
_end_if4083:
  ...
  %_4085 = add i64 %_id_i4084, 1
  store i64 %_4085, i64* %_4066
  br label %_start4086
_else4088:
...
_start4056:
  ...
  %_4039 = icmp slt i64 %_id_i4037, %_id_len4038
  br i1 %_4039, label %_body4057, label %_else4058
_body4057:
...
_begin_if4050:
  ...
  %_4045 = icmp sgt i64 %_index_value4043, %_id_max4044
  br i1 %_4045, label %_then_branch4051, label %_else_branch4052
_then_branch4051:
...
_end_if4053:
  ...
  %_4055 = add i64 %_id_i4054, 1
  store i64 %_4055, i64* %_4036
  br label %_start4056
_else4058:
...
define { i64, [0 x i64] }* @count_sort({ i64, [0 x i64] }* %arr, i64 %len) {
  ...
  %_3954 = sub i64 %_id_max3952, %_id_min3953
  %_3955 = add i64 %_3954, 1
  %_raw_array3956 = call i64* @oat_alloc_array(i64 %_3955)
...
_start3982:
  ...
  %_3961 = icmp slt i64 %_id_i3959, %_id_len3960
  br i1 %_3961, label %_body3983, label %_else3984
_body3983:
  ...
  %_3968 = sub i64 %_index_value3966, %_id_min3967
  %_index_pointer3969 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_counts3962, i32 0, i32 1, i64 %_3968
  %_index_value3970 = load i64, i64* %_index_pointer3969
  %_3971 = add i64 %_index_value3970, 1
  ...
  %_3978 = sub i64 %_index_value3976, %_id_min3977
  %_3979 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_counts3972, i32 0, i32 1, i64 %_3978
  store i64 %_3971, i64* %_3979
  %_id_i3980 = load i64, i64* %_3958
  %_3981 = add i64 %_id_i3980, 1
  store i64 %_3981, i64* %_3958
  br label %_start3982
_else3984:
...
_start4026:
  ...
  %_3994 = icmp sle i64 %_id_i3992, %_id_max3993
  br i1 %_3994, label %_body4027, label %_else4028
_body4027:
...
_begin_if4022:
  ...
  %_3998 = sub i64 %_id_i3996, %_id_min3997
  %_index_pointer3999 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_counts3995, i32 0, i32 1, i64 %_3998
  %_index_value4000 = load i64, i64* %_index_pointer3999
  %_4001 = icmp sgt i64 %_index_value4000, 0
  br i1 %_4001, label %_then_branch4023, label %_else_branch4024
_then_branch4023:
  ...
  %_4009 = sub i64 %_id_i4007, %_id_min4008
  %_index_pointer4010 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_counts4006, i32 0, i32 1, i64 %_4009
  %_index_value4011 = load i64, i64* %_index_pointer4010
  %_4012 = sub i64 %_index_value4011, 1
  %_id_counts4013 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_3951
  %_id_min4015 = load i64, i64* %_3943
  %_id_i4014 = load i64, i64* %_3985
  %_4016 = sub i64 %_id_i4014, %_id_min4015
  %_4017 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_counts4013, i32 0, i32 1, i64 %_4016
  store i64 %_4012, i64* %_4017
  %_id_j4018 = load i64, i64* %_3987
  %_4019 = add i64 %_id_j4018, 1
  store i64 %_4019, i64* %_3987
  br label %_end_if4025
_else_branch4024:
  %_id_i4020 = load i64, i64* %_3985
  %_4021 = add i64 %_id_i4020, 1
  store i64 %_4021, i64* %_3985
  br label %_end_if4025
_end_if4025:
  br label %_start4026
_else4028:
