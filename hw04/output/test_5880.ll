...
define { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %x, { i64, [0 x i64] }* %y, i1 %b) {
  ...
  store i1 %b, i1* %_b311
  br label %_begin_if318
_begin_if318:
  %_id_b312 = load i1, i1* %_b311
  br i1 %_id_b312, label %_then_branch317, label %_else_branch316
_then_branch317:
  %_id_x314 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_x309
  ret { i64, [0 x i64] }* %_id_x314
_else_branch316:
  %_id_y313 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_y310
  ret { i64, [0 x i64] }* %_id_y313
}
