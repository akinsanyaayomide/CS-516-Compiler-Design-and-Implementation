...
define { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %x, { i64, [0 x i64] }* %y, i1 %b) {
  ...
  store i1 %b, i1* %_b286
  br label %_begin_if290
_begin_if290:
  %_id_b287 = load i1, i1* %_b286
  br i1 %_id_b287, label %_then_branch291, label %_else_branch292
_then_branch291:
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer282 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_x281, i32 0, i32 1, i32 0
  %_index_value283 = load i64, i64* %_index_pointer282
  ret i64 %_index_value283
}
