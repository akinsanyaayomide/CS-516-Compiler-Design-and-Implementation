...
@_str_arr5004 = global [1 x i8] c"\00"
@_str_arr4986 = global [7 x i8] c"TOMATO\00"
@_str_arr4989 = global [8 x i8] c"ORATING\00"
...
_then5007:
  %_str5005 = getelementptr [1 x i8], [1 x i8]* @_str_arr5004, i32 0, i32 0
  ret i8* %_str5005
_else5008:
  br label %_post5009
_post5009:
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_str4987 = getelementptr [7 x i8], [7 x i8]* @_str_arr4986, i32 0, i32 0
  store i8* %_str4987, i8** %_4985
  %_str4990 = getelementptr [8 x i8], [8 x i8]* @_str_arr4989, i32 0, i32 0
  store i8* %_str4990, i8** %_4988
