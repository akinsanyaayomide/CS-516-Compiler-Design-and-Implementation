...
@_str_arr4515 = global [2 x i8] c"T\00"
@_str_arr4517 = global [2 x i8] c"F\00"
@_str_arr4490 = global [2 x i8] c" \00"
...
_then4520:
  %_str4516 = getelementptr [2 x i8], [2 x i8]* @_str_arr4515, i32 0, i32 0
  ret i8* %_str4516
_else4521:
  %_str4518 = getelementptr [2 x i8], [2 x i8]* @_str_arr4517, i32 0, i32 0
  ret i8* %_str4518
}
...
_else4486:
  ...
  %_str4491 = getelementptr [2 x i8], [2 x i8]* @_str_arr4490, i32 0, i32 0
