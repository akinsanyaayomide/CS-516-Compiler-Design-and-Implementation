...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer926 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_arr924, i32 0, i32 1, i32 1
  %_index_value925 = load i64, i64* %_index_pointer926
  ret i64 %_index_value925
}
