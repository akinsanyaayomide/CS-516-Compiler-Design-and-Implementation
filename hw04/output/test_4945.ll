...
define i64 @f(i64 %x1, i64 %x2, i64 %x3, i64 %x4, i64 %x5, i64 %x6, i64 %x7, i64 %x8) {
  ...
  %_bop672 = add i64 %_id_x1670, %_id_x2671
  %_id_x3673 = load i64, i64* %_x3664
  %_bop674 = add i64 %_bop672, %_id_x3673
  %_id_x4675 = load i64, i64* %_x4665
  %_bop676 = add i64 %_bop674, %_id_x4675
  %_id_x5677 = load i64, i64* %_x5666
  %_bop678 = add i64 %_bop676, %_id_x5677
  %_id_x6679 = load i64, i64* %_x6667
  %_bop680 = add i64 %_bop678, %_id_x6679
  %_id_x7681 = load i64, i64* %_x7668
  %_bop682 = add i64 %_bop680, %_id_x7681
  %_id_x8683 = load i64, i64* %_x8669
  %_bop684 = add i64 %_bop682, %_id_x8683
  ret i64 %_bop684
}
