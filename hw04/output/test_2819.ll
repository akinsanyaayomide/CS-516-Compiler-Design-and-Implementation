...
_begin_if430:
  ...
  %_index_pointer428 = getelementptr { i64, [0 x i1] }, { i64, [0 x i1] }* %_id_b427, i32 0, i32 1, i32 0
  %_index_value429 = load i1, i1* %_index_pointer428
  br i1 %_index_value429, label %_then_branch431, label %_else_branch432
_then_branch431:
