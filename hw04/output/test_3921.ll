...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer1105 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_id_garr1103, i32 0, i32 1, i32 1
  %_index_value1104 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_index_pointer1105
  %_1106 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_index_value1104)
