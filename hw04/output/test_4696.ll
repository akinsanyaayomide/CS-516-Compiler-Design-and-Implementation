...
define i64 @getminindex({ i64, [0 x i64] }* %a, i64 %s, i64 %b) {
  ...
  %_index_pointer3329 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a3326, i32 0, i32 1, i64 %_id_s3327
  %_index_value3328 = load i64, i64* %_index_pointer3329
  store i64 %_index_value3328, i64* %_3325
...
_cond3353:
  ...
  br i1 %_bop3334, label %_if3352, label %_merge3354
_if3352:
...
_begin_if3346:
  ...
  br i1 %_bop3340, label %_then_branch3347, label %_else_branch3348
_then_branch3347:
  ...
  store i64 %_index_value3343, i64* %_3325
...
_cond3318:
  ...
  br i1 %_bop3295, label %_if3317, label %_merge3319
_if3317:
  ...
  store i64 %_index_value3302, i64* %_3290
...
_cond3286:
  ...
  br i1 %_bop3277, label %_if3285, label %_merge3287
_if3285:
