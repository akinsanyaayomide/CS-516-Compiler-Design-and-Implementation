...
_begin_if4972:
  ...
  br i1 %_4961, label %_then_branch4973, label %_else_branch4974
_then_branch4973:
...
_begin_if4935:
  ...
  br i1 %_4922, label %_then_branch4936, label %_else_branch4937
_then_branch4936:
  br label %_begin_if4931
_begin_if4931:
  %_id_count4923 = load i64, i64* %_4868
  %_4924 = icmp slt i64 %_id_count4923, 2
  br i1 %_4924, label %_then_branch4932, label %_else_branch4933
_then_branch4932:
  ret i64 0
_else_branch4933:
...
_begin_if4927:
  ...
  br i1 %_4926, label %_then_branch4928, label %_else_branch4929
_then_branch4928:
  ret i64 1
_else_branch4929:
...
_begin_if4941:
  ...
  br i1 %_4940, label %_then_branch4942, label %_else_branch4943
_then_branch4942:
  ret i64 1
_else_branch4943:
  ret i64 0
...
_cond4829:
  ...
  br i1 %_4802, label %_if4828, label %_merge4830
_if4828:
...
_cond4824:
  ...
  br i1 %_4810, label %_if4823, label %_merge4825
_if4823:
...
_cond4855:
  ...
  br i1 %_4834, label %_if4854, label %_merge4856
_if4854:
...
_cond4850:
  ...
  br i1 %_4838, label %_if4849, label %_merge4851
_if4849:
