...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  store i64 0, i64* %_s543
  store i64 0, i64* %_i544
  br label %_cond567
_cond567:
  %_id_i545 = load i64, i64* %_i544
  %_bop546 = icmp slt i64 %_id_i545, 3
  br i1 %_bop546, label %_if568, label %_merge566
_if568:
  store i64 0, i64* %_j547
  br label %_cond562
_cond562:
  %_id_j548 = load i64, i64* %_j547
  %_bop549 = icmp slt i64 %_id_j548, 4
  br i1 %_bop549, label %_if563, label %_merge561
_if563:
  %_id_s550 = load i64, i64* %_s543
  %_id_a551 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @a
  %_id_i552 = load i64, i64* %_i544
  ...
  store i64 %_bop558, i64* %_s543
  %_id_j559 = load i64, i64* %_j547
  %_bop560 = add i64 %_id_j559, 1
  store i64 %_bop560, i64* %_j547
  br label %_cond562
_merge561:
  %_id_i564 = load i64, i64* %_i544
  %_bop565 = add i64 %_id_i564, 1
  store i64 %_bop565, i64* %_i544
  br label %_cond567
_merge566:
  %_id_s569 = load i64, i64* %_s543
  ret i64 %_id_s569
}
