...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_index_pointer915 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_arr913, i32 0, i32 1, i32 1
  %_index_value914 = load i64, i64* %_index_pointer915
  ret i64 %_index_value914
}
