...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  br label %_begin_if57
_begin_if57:
  %_id_x43 = load i64, i64* %_x40
  %_id_y44 = load i64, i64* %_y42
  %_bop45 = sub i64 %_id_x43, %_id_y44
  %_bop46 = icmp sle i64 %_bop45, 0
  br i1 %_bop46, label %_then_branch56, label %_else_branch55
_then_branch56:
  %_id_x50 = load i64, i64* %_x40
  %_unop51 = sub i64 0, %_id_x50
  %_id_y52 = load i64, i64* %_y42
  %_bop53 = sub i64 %_unop51, %_id_y52
  ret i64 %_bop53
_else_branch55:
  %_id_x47 = load i64, i64* %_x40
  %_id_y48 = load i64, i64* %_y42
  %_bop49 = sub i64 %_id_x47, %_id_y48
  ret i64 %_bop49
}
