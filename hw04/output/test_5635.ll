...
_then_branch4024:
  ...
  %_id_out4003 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_out3991
  %_id_j4004 = load i64, i64* %_j3987
  %_4005 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_out4003, i32 0, i32 1, i64 %_id_j4004
  store i64 %_id_i4002, i64* %_4005
  %_id_counts4006 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_counts3957
  %_id_i4007 = load i64, i64* %_i3986
  %_id_min4008 = load i64, i64* %_min3946
  %_bop4009 = sub i64 %_id_i4007, %_id_min4008
  %_index_pointer4011 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_counts4006, i32 0, i32 1, i64 %_bop4009
  %_index_value4010 = load i64, i64* %_index_pointer4011
  %_bop4012 = sub i64 %_index_value4010, 1
  %_id_counts4013 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_counts3957
  %_id_i4014 = load i64, i64* %_i3986
  %_id_min4015 = load i64, i64* %_min3946
  ...
  %_id_j4018 = load i64, i64* %_j3987
  %_bop4019 = add i64 %_id_j4018, 1
  store i64 %_bop4019, i64* %_j3987
  br label %_end_if4022
_else_branch4023:
  %_id_i4020 = load i64, i64* %_i3986
  %_bop4021 = add i64 %_id_i4020, 1
  store i64 %_bop4021, i64* %_i3986
  br label %_end_if4022
_end_if4022:
  br label %_cond4027
_merge4028:
