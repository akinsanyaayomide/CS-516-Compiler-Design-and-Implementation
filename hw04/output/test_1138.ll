...
_body3383:
  ...
  %_string13378 = getelementptr [2 x i8], [2 x i8]* @_string3377, i32 0, i32 0
  call void @print_string(i8* %_string13378)
  %_id_j3380 = load i64, i64* %_3366
  %_3381 = add i64 %_id_j3380, 1
  store i64 %_3381, i64* %_3366
  br label %_start3382
_else3384:
  %_string13386 = getelementptr [2 x i8], [2 x i8]* @_string3385, i32 0, i32 0
  call void @print_string(i8* %_string13386)
