...
define void @bubble_sort({ i64, [0 x i64] }* %numbers, i64 %array_size) {
  ...
  %_bop2846 = sub i64 %_id_array_size2845, 1
  store i64 %_bop2846, i64* %_2844
  br label %_cond2892
_cond2892:
...
_begin_if2880:
  ...
  %_index_pointer2856 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_numbers2853, i32 0, i32 1, i64 %_bop2855
  ...
  %_bop2862 = icmp sgt i64 %_index_value2857, %_index_value2861
...
_then_branch2881:
  ...
  %_index_pointer2866 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_numbers2863, i32 0, i32 1, i64 %_bop2865
...
_end_if2883:
  ...
  store i64 %_bop2885, i64* %_2849
  br label %_cond2887
_merge2888:
  %_id_i2889 = load i64, i64* %_2844
  %_bop2890 = sub i64 %_id_i2889, 1
  store i64 %_bop2890, i64* %_2844
  br label %_cond2892
_merge2893:
  ret void
}
