...
_begin_if3706:
  ...
  %_3700 = icmp slt i64 %_id_denominator3699, 0
  br i1 %_3700, label %_then_branch3707, label %_else_branch3708
_then_branch3707:
...
_begin_if3739:
  ...
  %_3714 = icmp slt i64 %_id_numerator3713, 0
  br i1 %_3714, label %_then_branch3740, label %_else_branch3741
_then_branch3740:
...
_start3725:
  ...
  %_3719 = icmp sge i64 %_id_remainder3717, %_id_denominator3718
  br i1 %_3719, label %_body3726, label %_else3727
_body3726:
  %_id_quotient3720 = load i64, i64* %_3710
  %_3721 = add i64 %_id_quotient3720, 1
  store i64 %_3721, i64* %_3710
  %_id_denominator3723 = load i64, i64* %_denominator3698
  %_id_remainder3722 = load i64, i64* %_3711
  %_3724 = sub i64 %_id_remainder3722, %_id_denominator3723
  store i64 %_3724, i64* %_3711
  br label %_start3725
_else3727:
  br label %_begin_if3735
_begin_if3735:
  %_id_remainder3728 = load i64, i64* %_3711
  %_3729 = icmp eq i64 %_id_remainder3728, 0
  br i1 %_3729, label %_then_branch3736, label %_else_branch3737
_then_branch3736:
...
_start3751:
  ...
  %_3745 = icmp sge i64 %_id_remainder3743, %_id_denominator3744
  br i1 %_3745, label %_body3752, label %_else3753
_body3752:
  %_id_quotient3746 = load i64, i64* %_3710
  %_3747 = add i64 %_id_quotient3746, 1
  store i64 %_3747, i64* %_3710
  %_id_denominator3749 = load i64, i64* %_denominator3698
  %_id_remainder3748 = load i64, i64* %_3711
  %_3750 = sub i64 %_id_remainder3748, %_id_denominator3749
  store i64 %_3750, i64* %_3711
  br label %_start3751
_else3753:
...
_begin_if3656:
  ...
  %_3655 = icmp slt i64 %_id_max3653, %_id_min3654
  br i1 %_3655, label %_then_branch3657, label %_else_branch3658
_then_branch3657:
  ret i1 0
_else_branch3658:
...
_end_if3659:
  ...
  %_3663 = add i64 %_id_max3661, %_id_min3662
  %_3664 = call i64 @euclid_division(i64 %_3663, i64 2)
...
_begin_if3677:
  ...
  %_3670 = icmp sgt i64 %_index_value3668, %_id_key3669
  br i1 %_3670, label %_then_branch3678, label %_else_branch3679
_then_branch3678:
  ...
  %_3675 = sub i64 %_id_midpt3674, 1
  %_3676 = call i1 @binary_search({ i64, [0 x i64] }* %_id_input3671, i64 %_id_key3672, i64 %_id_min3673, i64 %_3675)
  ret i1 %_3676
_else_branch3679:
...
_begin_if3693:
  ...
  %_3686 = icmp slt i64 %_index_value3684, %_id_key3685
  br i1 %_3686, label %_then_branch3694, label %_else_branch3695
_then_branch3694:
  %_id_input3687 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_input3649
  %_id_key3688 = load i64, i64* %_key3650
  %_id_midpt3689 = load i64, i64* %_3660
  %_3690 = add i64 %_id_midpt3689, 1
  %_id_max3691 = load i64, i64* %_max3652
  %_3692 = call i1 @binary_search({ i64, [0 x i64] }* %_id_input3687, i64 %_id_key3688, i64 %_3690, i64 %_id_max3691)
  ret i1 %_3692
_else_branch3695:
  ret i1 1
}
...
_start3625:
  ...
  %_3616 = icmp slt i64 %_id_i3615, 100
  br i1 %_3616, label %_body3626, label %_else3627
_body3626:
  %_id_i3617 = load i64, i64* %_3614
  %_3618 = mul i64 2, %_id_i3617
  %_3619 = add i64 %_3618, 1
  ...
  store i64 %_3619, i64* %_3622
  %_id_i3623 = load i64, i64* %_3614
  %_3624 = add i64 %_id_i3623, 1
  store i64 %_3624, i64* %_3614
  br label %_start3625
_else3627:
...
_begin_if3645:
  ...
  %_3640 = or i1 %_id_even3638, %_id_odd3639
  %_id_odd3635 = load i1, i1* %_3631
  %_id_even3634 = load i1, i1* %_3628
  %_3636 = and i1 %_id_even3634, %_id_odd3635
  %_unop3637 = icmp eq i1 %_3636, 0
  %_3641 = and i1 %_unop3637, %_3640
  br i1 %_3641, label %_then_branch3646, label %_else_branch3647
_then_branch3646:
