...
@_str_arr3067 = global [2 x i8] c" \00"
@_str_arr3073 = global [2 x i8] c" \00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_str3068 = getelementptr [2 x i8], [2 x i8]* @_str_arr3067, i32 0, i32 0
  ...
  %_str3074 = getelementptr [2 x i8], [2 x i8]* @_str_arr3073, i32 0, i32 0
