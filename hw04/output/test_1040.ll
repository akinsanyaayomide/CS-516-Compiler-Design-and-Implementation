...
_then4520:
  %_string14516 = getelementptr [2 x i8], [2 x i8]* @_string4515, i32 0, i32 0
  ret i8* %_string14516
_else4521:
  %_string14518 = getelementptr [2 x i8], [2 x i8]* @_string4517, i32 0, i32 0
  ret i8* %_string14518
}
...
_else4486:
  ...
  %_string14491 = getelementptr [2 x i8], [2 x i8]* @_string4490, i32 0, i32 0
  call void @print_string(i8* %_string14491)
