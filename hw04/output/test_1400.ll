...
_start566:
  ...
  %_546 = icmp slt i64 %_id_i545, 3
  br i1 %_546, label %_body567, label %_else568
_body567:
  store i64 0, i64* %_547
  br label %_start561
_start561:
  %_id_j548 = load i64, i64* %_547
  %_549 = icmp slt i64 %_id_j548, 4
  br i1 %_549, label %_body562, label %_else563
_body562:
  %_id_a551 = load { i64, [0 x { i64, [0 x i64] }*] }*, { i64, [0 x { i64, [0 x i64] }*] }** @a
  %_id_i552 = load i64, i64* %_544
  %_index_pointer553 = getelementptr { i64, [0 x { i64, [0 x i64] }*] }, { i64, [0 x { i64, [0 x i64] }*] }* %_id_a551, i32 0, i32 1, i64 %_id_i552
  %_index_value554 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_index_pointer553
  %_id_j555 = load i64, i64* %_547
  %_index_pointer556 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_index_value554, i32 0, i32 1, i64 %_id_j555
  %_index_value557 = load i64, i64* %_index_pointer556
  %_id_s550 = load i64, i64* %_543
  %_558 = add i64 %_id_s550, %_index_value557
  store i64 %_558, i64* %_543
  %_id_j559 = load i64, i64* %_547
  %_560 = add i64 %_id_j559, 1
  store i64 %_560, i64* %_547
  br label %_start561
_else563:
  %_id_i564 = load i64, i64* %_544
  %_565 = add i64 %_id_i564, 1
  store i64 %_565, i64* %_544
  br label %_start566
_else568:
