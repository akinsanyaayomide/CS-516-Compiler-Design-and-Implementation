...
_start173:
  ...
  %_162 = icmp slt i64 %_id_i161, 4
  br i1 %_162, label %_body174, label %_else175
_body174:
  ...
  %_170 = sub i64 %_index_value168, %_id_ans169
  store i64 %_170, i64* %_159
  %_id_i171 = load i64, i64* %_160
  %_172 = add i64 %_id_i171, 1
  store i64 %_172, i64* %_160
  br label %_start173
_else175:
  br label %_begin_if183
_begin_if183:
  %_unop176 = xor i64 5, -1
  %_177 = and i64 5, %_unop176
  %_178 = or i64 %_177, 0
  %_179 = icmp ne i64 %_178, 0
  br i1 %_179, label %_then_branch184, label %_else_branch185
_then_branch184:
