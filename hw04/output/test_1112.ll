...
@_string1651 = global [4 x i8] c"def\00"
@_string1649 = global [4 x i8] c"abc\00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_string11652 = getelementptr [4 x i8], [4 x i8]* @_string1651, i32 0, i32 0
  %_string11650 = getelementptr [4 x i8], [4 x i8]* @_string1649, i32 0, i32 0
