...
_begin_if4999:
  ...
  %_4995 = icmp slt i64 %_id_j4994, 0
  %_id_i4992 = load i64, i64* %_i4988
  %_4993 = icmp slt i64 %_id_i4992, 0
  %_4996 = or i1 %_4993, %_4995
  br i1 %_4996, label %_then_branch5000, label %_else_branch5001
_then_branch5000:
...
_end_if5002:
  ...
  %_index_pointer5012 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a_chars5010, i32 0, i32 1, i64 %_id_i5011
  %_index_value5013 = load i64, i64* %_index_pointer5012
  store i64 %_index_value5013, i64* %_5009
  %_id_b_chars5015 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_5006
  %_id_j5016 = load i64, i64* %_j4989
  %_index_pointer5017 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_b_chars5015, i32 0, i32 1, i64 %_id_j5016
  %_index_value5018 = load i64, i64* %_index_pointer5017
  store i64 %_index_value5018, i64* %_5014
  br label %_begin_if5042
_begin_if5042:
  %_id_last_char_b5020 = load i64, i64* %_5014
  %_id_last_char_a5019 = load i64, i64* %_5009
  %_5021 = icmp eq i64 %_id_last_char_a5019, %_id_last_char_b5020
  br i1 %_5021, label %_then_branch5043, label %_else_branch5044
_then_branch5043:
  %_id_i5023 = load i64, i64* %_i4988
  %_5024 = sub i64 %_id_i5023, 1
  %_id_j5025 = load i64, i64* %_j4989
  %_5026 = sub i64 %_id_j5025, 1
  %_id_a5027 = load i8*, i8** %_a4990
  %_id_b5028 = load i8*, i8** %_b4991
  %_5029 = call i8* @lcs(i64 %_5024, i64 %_5026, i8* %_id_a5027, i8* %_id_b5028)
  store i8* %_5029, i8** %_5022
  %_id_a_chars5030 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** %_5003
  %_id_i5031 = load i64, i64* %_i4988
  %_index_pointer5032 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_a_chars5030, i32 0, i32 1, i64 %_id_i5031
  %_index_value5033 = load i64, i64* %_index_pointer5032
  ...
  store i64 %_index_value5033, i64* %_5035
...
_begin_if5071:
  ...
  %_5068 = icmp slt i64 %_id_left_len5066, %_id_right_len5067
  br i1 %_5068, label %_then_branch5072, label %_else_branch5073
_then_branch5072:
