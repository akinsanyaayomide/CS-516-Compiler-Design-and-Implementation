...
define { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %x, { i64, [0 x i64] }* %y, i1 %b) {
  ...
  br i1 %_id_b331, label %_if334, label %_else335
_if334:
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_id_x311 = bitcast { i64, [3 x i64] }* @x to { i64, [0 x i64] }*
  %_id_y312 = bitcast { i64, [3 x i64] }* @y to { i64, [0 x i64] }*
  %_313 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_id_x311, { i64, [0 x i64] }* %_id_y312, i1 1)
  %_314 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_313, i32 0, i32 1, i32 0
  store i64 17, i64* %_314
  %_id_y321 = bitcast { i64, [3 x i64] }* @y to { i64, [0 x i64] }*
  %_id_x322 = bitcast { i64, [3 x i64] }* @x to { i64, [0 x i64] }*
  %_323 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_id_y321, { i64, [0 x i64] }* %_id_x322, i1 0)
  ...
  %_id_x316 = bitcast { i64, [3 x i64] }* @x to { i64, [0 x i64] }*
  %_id_y317 = bitcast { i64, [3 x i64] }* @y to { i64, [0 x i64] }*
  %_318 = call { i64, [0 x i64] }* @f({ i64, [0 x i64] }* %_id_x316, { i64, [0 x i64] }* %_id_y317, i1 1)
