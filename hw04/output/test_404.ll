...
@_raw_string4516 = global [2 x i8] c"T\00"
@_raw_string4518 = global [2 x i8] c"F\00"
@_raw_string4491 = global [2 x i8] c" \00"
...
_then4520:
  %_result_id4515 = bitcast [2 x i8]* @_raw_string4516 to i8*
  ret i8* %_result_id4515
_else4521:
  %_result_id4517 = bitcast [2 x i8]* @_raw_string4518 to i8*
  ret i8* %_result_id4517
}
...
_else4486:
  ...
  %_result_id4490 = bitcast [2 x i8]* @_raw_string4491 to i8*
  call void @print_string(i8* %_result_id4490)
