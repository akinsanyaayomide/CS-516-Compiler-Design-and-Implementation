...
define { i64, [0 x i64] }* @insert({ i64, [0 x i64] }* %partial, i64 %len, i64 %insertee) {
  ...
  %_5132 = add i64 %_id_len5131, 1
  %_raw_array5133 = call i64* @oat_alloc_array(i64 %_5132)
...
_start5146:
  ...
  %_5138 = add i64 %_id_len5137, 1
  %_id_i5136 = load i64, i64* %_5135
  %_5139 = icmp slt i64 %_id_i5136, %_5138
  br i1 %_5139, label %_body5147, label %_else5148
_body5147:
  ...
  %_5145 = add i64 %_id_i5144, 1
  store i64 %_5145, i64* %_5135
  br label %_start5146
_else5148:
  store i1 1, i1* %_5149
  br label %_start5158
_start5158:
  ...
  %_5154 = icmp slt i64 %_id_insertee5150, %_index_value5153
  br i1 %_5154, label %_then5159, label %_else5160
_then5159:
  store i1 0, i1* %_5149
...
_start5210:
  ...
  %_5165 = icmp slt i64 %_id_i5163, %_id_len5164
  br i1 %_5165, label %_body5211, label %_else5212
_body5211:
  br label %_start5204
_start5204:
  %_id_not_yet_inserted5166 = load i1, i1* %_5149
  br i1 %_id_not_yet_inserted5166, label %_then5205, label %_else5206
_then5205:
  br label %_start5192
_start5192:
  ...
  %_5172 = icmp sgt i64 %_id_insertee5167, %_index_value5171
  br i1 %_5172, label %_then5193, label %_else5194
_then5193:
  store i1 0, i1* %_5149
  ...
  %_5176 = add i64 %_id_i5175, 1
  %_5177 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_inserted5174, i32 0, i32 1, i64 %_5176
...
_else5206:
  ...
  %_5202 = add i64 %_id_i5201, 1
  %_5203 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_inserted5200, i32 0, i32 1, i64 %_5202
  store i64 %_index_value5199, i64* %_5203
  br label %_post5207
_post5207:
  %_id_i5208 = load i64, i64* %_5162
  %_5209 = add i64 %_id_i5208, 1
  store i64 %_5209, i64* %_5162
  br label %_start5210
_else5212:
...
_start5123:
  ...
  %_5113 = icmp slt i64 %_id_i5111, %_id_len5112
  br i1 %_5113, label %_body5124, label %_else5125
_body5124:
  ...
  %_5122 = add i64 %_id_i5121, 1
  store i64 %_5122, i64* %_5110
  br label %_start5123
_else5125:
