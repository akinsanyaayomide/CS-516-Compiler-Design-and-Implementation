...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_882 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_array879, i32 0, i32 1, i32 1
  store i64 42, i64* %_882
  ...
  %_id_arr884 = load { i64, [0 x i64] }*, { i64, [0 x i64] }** @arr
  %_index_pointer885 = getelementptr { i64, [0 x i64] }, { i64, [0 x i64] }* %_id_arr884, i32 0, i32 1, i32 1
  %_index_value886 = load i64, i64* %_index_pointer885
  ret i64 %_index_value886
}
