...
@_string1680 = global [4 x i8] c"123\00"
@_string1678 = global [4 x i8] c"789\00"
@_string1670 = global [4 x i8] c"def\00"
@_string1668 = global [4 x i8] c"abc\00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_string11681 = getelementptr [4 x i8], [4 x i8]* @_string1680, i32 0, i32 0
  %_string11679 = getelementptr [4 x i8], [4 x i8]* @_string1678, i32 0, i32 0
  ...
  store i8* %_string11681, i8** %_1684
  %_1682 = getelementptr { i64, [0 x i8*] }, { i64, [0 x i8*] }* %_array1677, i32 0, i32 1, i32 0
  store i8* %_string11679, i8** %_1682
  %_string11671 = getelementptr [4 x i8], [4 x i8]* @_string1670, i32 0, i32 0
  %_string11669 = getelementptr [4 x i8], [4 x i8]* @_string1668, i32 0, i32 0
