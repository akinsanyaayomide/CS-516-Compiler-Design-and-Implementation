...
@_raw_string5005 = global [1 x i8] c"\00"
@_raw_string4987 = global [7 x i8] c"TOMATO\00"
@_raw_string4990 = global [8 x i8] c"ORATING\00"
...
_then5007:
  %_result_id5004 = bitcast [1 x i8]* @_raw_string5005 to i8*
  ret i8* %_result_id5004
_else5008:
  br label %_post5009
_post5009:
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_result_id4986 = bitcast [7 x i8]* @_raw_string4987 to i8*
  store i8* %_result_id4986, i8** %_4985
  %_result_id4989 = bitcast [8 x i8]* @_raw_string4990 to i8*
  store i8* %_result_id4989, i8** %_4988
