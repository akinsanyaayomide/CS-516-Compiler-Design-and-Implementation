...
@_raw_string2550 = global [11 x i8] c"1234967890\00"
...
define i64 @program(i64 %argc, { i64, [0 x i8*] }* %argv) {
  ...
  %_result_id2549 = bitcast [11 x i8]* @_raw_string2550 to i8*
  %_2551 = call { i64, [0 x i64] }* @array_of_string(i8* %_result_id2549)
